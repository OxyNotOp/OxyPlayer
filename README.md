...
License -> https://github.com/OxyNotOp/OxyPlayer/blob/master/LICENSE

```

## Deploy to Heroku

[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/OxyNotOp/OxyPlayer)

NOTE: Make sure you have started a VoiceChat in your Group before deploying.
### Deploy to VPS

```sh
git clone https://github.com/OxyNotOp/OxyPlayer
cd MusicPlayer
...
4. `SESSION_STRING` : Generate From here [![GenerateStringName](https://img.shields.io/badge/repl.it-generateStringName-yellowgreen)](https://repl.it/@OXYOPps/getStringName)
...
9. `STREAM_URL` : Stream URL of radio station or a youtube live video to stream when the bot starts or with /radio command. [Some Streaming Links](https://gist.github.com/OXYOPps/293d0a117fa0b13da41871538f226956)
...
Connect Me On [Telegram](https://telegram.dog/OXYOPps_bot)
